...
Read [workspace integration keys](hub/integration-keys.md) for metadata, rotation and interactive-only management, and [qualified catalog discovery](hub/catalog.md) for service/tag separation and supported-version fallback. Denials and outages do not justify changing identity, workspace or policy.
